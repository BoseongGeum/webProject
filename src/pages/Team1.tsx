            ...
            <div className="flex flex-col h-full transition-all ease-in-out">
                {blocks.map((block) => {
                    ...
                    return (
                        <motion.div
                            key={block.id}
                            className="relative group bg-cover bg-no-repeat bg-center cursor-pointer transition-all duration-500 ease-in-out"
                            style={{
                                backgroundImage: `url(${bgImage})`,
                                flexGrow: isActive ? 1.25 : 1,
                                flexBasis: 0,
                                minHeight: "80px",
                            }}
                                ...
                                <div className="w-full lg:w-1/2 flex items-center justify-center mb-4 lg:mb-0 px-2 text-center">
                                    <AnimatePresence>
                                        {isActive && (
                                            <motion.div
                                                key={`text-${block.id}`}
                                                className="whitespace-pre-line text-yellow-300 text-base md:text-lg leading-relaxed"
                                                initial={{ opacity: 0 }}
                                                animate={{ opacity: 1 }}
                                                exit={{ opacity: 0 }}
