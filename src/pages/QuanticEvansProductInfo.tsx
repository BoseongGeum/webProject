...
const QuanticEvansProductInfo: React.FC = () => {
    ...
    return (
        ...
        <div className="pt-16 w-full min-h-screen text-black font-bold pb-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* 서문 설명 */}
                <div className="text-left text-base sm:text-lg text-gray-700 mb-20 space-y-4 leading-relaxed">
                ...
                <section className="mb-20">
                    ...
                    <ul className="list-disc list-inside space-y-3 ml-2 text-base sm:text-lg text-gray-700 leading-relaxed">
