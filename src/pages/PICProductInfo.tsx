                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-20">
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-full h-1/3 text-center">
                            <span className="text-yellow-300 text-xl font-semibold">커넥터</span>
                            <p className="text-gray-200 text-lg mt-4">
                ...
                <div className="w-full flex items-center justify-between mt-12">
                    ...
                    <AnimatePresence>
                        <motion.div
                            ...
                            className="w-32 px-2 py-1 border-2 border-yellow-300 bg-black bg-opacity-30 text-yellow-300 hover:text-black hover:bg-yellow-300 rounded-none text-lg text-center flex items-center justify-center"
                        >
                            <Link
                                to={"/picManagerInfo"}
